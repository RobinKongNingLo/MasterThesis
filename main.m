t_step = 0.005; %online estimation; t_step = 0.0075, b-a = 3, t = 0.025/example
a = 0;
b = 10;
noise_snr = -10;
tspan = [a:t_step:b];
...
plot(tspan(1,1:N), y, 'Color', '#EDB120')
hold on
plot(tspan(1,1:N), x_pred, 'Color',	'#D95319')
plot(tspan(1,1:N), x , 'Color', '#0072BD')
